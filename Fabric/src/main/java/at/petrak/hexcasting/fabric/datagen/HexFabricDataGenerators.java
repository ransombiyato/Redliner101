...
public class HexFabricDataGenerators implements DataGeneratorEntrypoint {
    ...
    public void onInitializeDataGenerator(FabricDataGenerator gen) {
        ...
        pack.addProvider(HexFabricRecipeProvider::new);
        ...
        pack.addProvider((output, lookup) -> new HexItemTagProvider(output, lookup, xtags));
    ...
    static final IXplatIngredients INGREDIENTS = new IXplatIngredients() {
        @Override
        public Ingredient glowstoneDust() {
            return conventionTag("glowstone_dusts");
        }
        ...
        public Ingredient ironNugget() {
            return conventionTag("iron_nuggets");
        }

        @Override
        public Ingredient goldNugget() {
            return conventionTag("gold_nuggets");
        }

        @Override
        public Ingredient copperIngot() {
            return conventionTag("copper_ingots");
        }

        @Override
        public Ingredient ironIngot() {
            return conventionTag("iron_ingots");
        }

        @Override
        public Ingredient goldIngot() {
            return conventionTag("gold_ingots");
        }
        ...
        public EnumMap<DyeColor, Ingredient> dyes() {
            ...
            for (var col : DyeColor.values()) {
                out.put(col, conventionTag(col.getSerializedName() + "_dyes"));
            }
            return out;
        }
        ...
        public Ingredient stick() {
            return conventionTag("wood_sticks");
        }
    ...
    private static Ingredient conventionTag(String path) {
        return Ingredient.of(HolderSet.emptyNamed(BuiltInRegistries.ITEM, tag(path)));
    }
    ...
    private static TagKey<Item> tag(String namespace, String s) {
        return TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(namespace, s));
    }
